"""
Description: Virtual world for the application
"""
...
##While extinguishing fire, the robot got stuck in a narrow path and was not able to get out of it.
#  Make sure to keep some distance from obstacles so that the robot does not get stuck